    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation"
                action="{{ isset($editrole) ? route('filetrack.role.update', $editrole->id) : route('filetrack.role.store') }}"
            ...
            <table class="datatables-basic table datatable  w-100">
                ...
                <tbody>
                    @foreach ($roles as $role)
                                    ...
                                    <div class="mb-1 breadcrumb-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a class="dropdown-item" href="{{ route('filetrack.role.edit', $rid) }}"><i
                        ...
                        <form id="delete-form-{{ $rid }}" action="{{ route('filetrack.role.destroy', $rid) }}"
