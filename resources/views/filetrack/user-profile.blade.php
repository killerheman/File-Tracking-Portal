...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" action="{{route('filetrack.fileuser.updateProfile') }}" method='post'
                ...
                <div class="row">
                    <div class="col-md-3 mb-1">
                        <img src="{{ Auth::guard('fileuser')->user()->pic_url }}" class="me-75 bg-light-danger"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-1">
                        ...
                        <input type="text" id="basic-addon-name" name='last_name' class="form-control"
                            value="{{ Auth::guard('fileuser')->user()->last_name }}" placeholder="Name" aria-label="Name"
                    ...
                    <div class="col-md-6 mb-1">
                        ...
                        <input type="email" id="basic-addon-name" name='email' class="form-control"
                            value="{{ Auth::guard('fileuser')->user()->email }}" placeholder="Email" aria-label="Name"
                    ...
                    <div class="col-md-6 mb-1">
                        ...
                        <input type="text" id="basic-addon-name" name='phone' class="form-control"
                            value="{{ Auth::guard('fileuser')->user()->phone }}" placeholder="Phone" aria-label="Name"
