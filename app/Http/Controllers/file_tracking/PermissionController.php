...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('filetrack.permission', compact('permissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('filetrack.user_permission', compact('roles', 'permissions', 'editpermission', 'editrole'));
    }
    ...
    public function userPermission()
    {
        $roles = Role::all();
        $permissions = PermissionName::all();
        return view('filetrack.user_permission', compact('roles', 'permissions'));
    }
    ...
    public function roleHasPermission()
    {
        ...
        return view('filetrack.role_has_permission', compact('role', 'permissions'));
    }
}
